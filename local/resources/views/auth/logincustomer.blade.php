...
<head>
    ...
    <meta name="description"
        content="appbefriends">
    <meta name="keywords"
        content="appbefriends">
    <meta name="author" content="LEFT4CODE">
    <title>AppBringme Login Member</title>
    <!-- BEGIN: CSS Assets-->
                ...
                <div
                    ...
                    <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">A few more clicks to sign in to
                        ...
                        <div class="intro-x mt-8">
                            <input type="text"
                                class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} intro-x login__input form-control py-3 px-4 block"
                                name="email" value="{{ old('email') }}" id="text" placeholder="email"
                            ...
                            <input type="password" id="password" name="password" placeholder="password"
                                ...
                                class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} intro-x login__input form-control py-3 px-4 block mt-4"
                                required>
