...
<div class="content">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <a href="campaign-add.php" class="btn btn-primary shadow-md mr-2">เพิ่มแคมเปญ</a>
                    ...
                    <table class="table table-report -mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="whitespace-nowrap">แคมเปญ</th>
                                <th class="text-center whitespace-nowrap">วันที่เริ่มแคมเปญ</th>
                                <th class="text-center whitespace-nowrap">วันที่สิ้นสุดแคมเปญ</th>
                        ...
                        <tbody>
                            <tr class="intro-x">
                                ...
                                <td>
                                    <a href="" class="font-medium whitespace-nowrap">[1-31 มีนาคม 66] Bring Me จัดแคมเปญดีลลดเดือด 3.3 Month Sale</a>
                                ...
                                <td class="w-40">
                                    <div class="flex items-center justify-center text-success"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> กำลังจะเริ่ม </div>
                                </td>
                                <td class="table-report__action">
                                    <div class="flex justify-center items-center">
                                    <a class="flex items-center whitespace-nowrap mr-3" href="campaign-join.php"><i data-lucide="home" class="w-4 h-4 mr-1"></i> ร้านค้าที่เข้าร่วม </a>
                                        <a class="flex items-center mr-3" href="campaign-edit.php"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i> แก้ไข </a>
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="text-center w-40">28 ก.พ. 66 - 23:59</td>
                                <td class="w-40">
                                    <div class="flex items-center justify-center text-sky-600"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> เริ่มแล้ว </div>
                                </td>
                                <td class="table-report__action ">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center whitespace-nowrap mr-3" href="campaign-join.php"><i data-lucide="home" class="w-4 h-4 mr-1"></i> ร้านค้าที่เข้าร่วม </a>
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="text-center w-40">28 ก.พ. 66 - 23:59</td>
                                <td class="w-40">
                                    <div class="flex items-center justify-center text-danger"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> ผ่านไปแล้ว </div>
                                </td>
                                <td class="table-report__action">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center whitespace-nowrap mr-3" href="campaign-join.php"><i data-lucide="home" class="w-4 h-4 mr-1"></i> ร้านค้าที่เข้าร่วม </a>
