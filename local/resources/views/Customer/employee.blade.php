                        ...
                        <table class="table table-report -mt-2">
                            ...
                            <tbody>
                                <tr class="intro-x">
                                    ...
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">สุพิชฌาย์ วัชรกิจ</a> 
                                        <!-- <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Electronic</div> -->
                                    </td>
                                    <td class="text-center w-40">ผู้ดูแลระบบ 1</td>
                                    <td class="w-40">
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">ณิชนันทน์ สุขเกษร </a> 
                                        <!-- <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Electronic</div> -->
                                    </td>
                                    <td class="text-center w-40">ผู้ดูแลระบบ 1</td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-danger"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> ไม่ได้ใช้งาน </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="employee-edit.php"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i>  แก้ไข </a>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">ธฤติพันธ์ กลิ่นเพชร</a> 
                                        <!-- <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Electronic</div> -->
                                    </td>
                                    <td class="text-center w-40">ผู้ดูแลระบบ 1</td>
                                    <td class="w-40">
