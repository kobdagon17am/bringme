        ...
        <div class="content">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <a href="promo-free-gift-add.php" class="btn btn-primary shadow-md mr-2">เพิ่มโปรโมชันของแถม</a>
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="table-report__action">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="promo-free-gift-edit.php"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i> แก้ไข </a>
