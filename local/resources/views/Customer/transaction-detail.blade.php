...
<div class="content">
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <button class="btn btn-primary shadow-md mr-2">พิมพ์</button>
                    <div class="dropdown ml-auto sm:ml-0" style="position: relative;">
                        ...
                        <div class="dropdown-menu w-40" id="_mgpqurktf" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(0px, 38px, 0px);">
                            <ul class="dropdown-content">
                                ...
                                <li>
                                    <a href="" class="dropdown-item">
                                        <i data-lucide="file" class="w-4 h-4 mr-2">
                                        </i> Export PDF
                                    </a>
                                </li>
                            </ul>
