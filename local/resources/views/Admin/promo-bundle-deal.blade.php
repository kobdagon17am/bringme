    ...
    <div class="flex overflow-hidden">
        ...
        <div class="content">
            <h2 class="intro-y text-lg font-medium mt-10">
                ข้อมูลโปรโมชัน Bundle Deal
            </h2>
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <a href="promo-bundle-deal-add.php" class="btn btn-primary shadow-md mr-2">เพิ่มโปรโมชัน Bundle Deal</a>
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="table-report__action">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="promo-bundle-deal-edit.php"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i> แก้ไข </a>
