                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            <tr class="intro-x">
                                <td class="">1</td>
                                <td class="w-full"><a href="" class="font-medium whitespace-nowrap">ผู้ดูแลระบบ 1</a></td>
                                <td class="table-report__action w-full">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="permission-edit.php"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i> แก้ไข </a>
                            ...
                            <tr class="intro-x">
                                <td class="">2</td>
                                <td class="w-full"><a href="" class="font-medium whitespace-nowrap">ผู้ดูแลระบบ 2</a></td>
                                <td class="table-report__action w-full">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="permission-edit.php"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i> แก้ไข </a>
                                        <a class="flex items-center text-danger" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> ลบ </a>
                            ...
                            <tr class="intro-x">
                                <td class="">3</td>
                                <td class="w-full"><a href="" class="font-medium whitespace-nowrap">ผู้ดูแลระบบ 3</a></td>
                                <td class="table-report__action w-full">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="permission-edit.php" ><i data-lucide="check-square" class="w-4 h-4 mr-1"></i> แก้ไข </a>
                                        <a class="flex items-center text-danger" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> ลบ </a>
