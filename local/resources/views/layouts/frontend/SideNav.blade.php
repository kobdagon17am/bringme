<nav class="side-nav">
    <ul>
        ...
        <li>
            <a href="{{route('permission')}}" class="side-menu">
        ...
        <li>
            ...
            <ul class="">
                ...
                <li>
                    ...
                    <ul class="">
                        <li>
                            <a href="{{route('stores')}}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> รายการร้านค้า </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('stores-waitapproved')}}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
        ...
        <li>
            <a href="{{route('campaign')}}" class="side-menu">
        ...
        <li>
            ...
            <ul class="">
                <li>
                    <a href="{{route('discount-code')}}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                ...
                <li>
                    ...
                    <ul class="">
                        <li>
                            <a href="{{route('promo-discount-product')}}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> โปรโมชันส่วนลดสินค้า </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('promo-free-gift')}}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> โปรโมชันแถมสินค้า </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('promo-bundle-deal')}}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> โปรโมชัน Bundle Deal </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('promo-add-on')}}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{route('create-bill-lading')}}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title"> สร้างใบเบิก</div>
                    </a>
                </li>
                <li>
                    <a href="{{route('bill-lading')}}" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
