            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 xl:col-span-8 mt-6">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="report-maps mt-5 bg-slate-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="{{ asset('backend/dist/json/location.json')}}"></div>
                    </div>
                </div>
                <!-- END: Official Store -->
                ...
                <div class="col-span-12 xl:col-span-4 mt-6">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template" src="{{ asset('backend/dist/images/profile-1.jpg')}}">
                                </div>
                                <div class="ml-4 mr-auto">
                            ...
                            <tbody>
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-11.jpg')}}" title="Uploaded at 12 February 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-3.jpg')}}" title="Uploaded at 20 September 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-4.jpg')}}" title="Uploaded at 3 May 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-11.jpg')}}" title="Uploaded at 20 June 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-4.jpg')}}" title="Uploaded at 19 April 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-11.jpg')}}" title="Uploaded at 13 March 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-7.jpg')}}" title="Uploaded at 29 January 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-1.jpg')}}" title="Uploaded at 27 May 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-3.jpg')}}" title="Uploaded at 22 March 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-8.jpg')}}" title="Uploaded at 28 March 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-1.jpg')}}" title="Uploaded at 27 June 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend/dist/images/preview-9.jpg')}}" title="Uploaded at 25 December 2020">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                        ...
                        <div class="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                    ...
                                    <div class="text-slate-500">
                                        ...
                                        <div class="flex mt-2">
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Sony A7 III">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('backend/dist/images/preview-15.jpg')}}">
                                            </div>
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('backend/dist/images/preview-5.jpg')}}">
                                            </div>
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Oppo Find X2 Pro">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('backend/dist/images/preview-1.jpg')}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="{{ asset('backend/dist/images/profile-14.jpg')}}">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
