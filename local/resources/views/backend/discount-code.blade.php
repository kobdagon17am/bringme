...
<div class="content">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <a href="{{route('admin/discount-code-add')}}" class="btn btn-primary shadow-md mr-2">เพิ่มโค้ดส่วนลด</a>
                    ...
                    <table class="table table-report -mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="whitespace-nowrap">ชื่อโค้ดส่วนลด</th>
                                <th class="whitespace-nowrap">โค้ดส่วนลด</th>
                        ...
                        <tbody>
                            <tr class="intro-x">
                                ...
                                <td class="">Coupon126</td>
                                <td class="">Coupon126</td>
                                <td class="">ส่วนลด 50 บาท</td>
                                ...
                                <td class="table-report__action">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="discount-code-edit.php"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i> แก้ไข </a>
