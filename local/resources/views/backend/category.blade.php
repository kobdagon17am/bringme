...
<div class="content">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <a href="{{route('admin/setting-category-add')}}" class="btn btn-primary shadow-md mr-2">เพิ่มหมวดหมู่ใหม่</a>
                    <div class="dropdown">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        table_order = $('#workL').DataTable({
            ...
            ajax: {
                url: '{{ url("admin/setting-category_datatable") }}',
                data: function(d) {
                },
            },
        ...
        $('#workL').on('click', '.delete-category', function() {
