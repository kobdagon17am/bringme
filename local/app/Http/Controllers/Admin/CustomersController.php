...
class CustomersController extends Controller
{
    ...
    public function customers_view($id){
        ...
        $data['address'] = DB::table('customer_address')
                                ...
                                ->select('districts.name_th as provinces_name', 'amphures.name_th as amphures_name', 'districts.name_th as districts_name', 'zipcode', 'address_number', 'tel')
                                ->leftJoin('districts','districts.id','=','customer_address.province_id')
